			...
			<div class="row">
				<div class="well col-md-5 center login-box">
					<%
						...
						if (!isSet) {
							if (request.getParameter("msg").equals("erreur")) {
					%>
					<div class="alert alert-danger">
						<button type="button" class="close" data-dismiss="alert">&times;</button>
						<strong>Erreur: login || password !</strong>
					</div>
					<%
						} else if (request.getParameter("msg").equals("echec")) {
					%>
					<div class="alert alert-danger">
						<button type="button" class="close" data-dismiss="alert">&times;</button>
						<strong> Tu dois te connecter d'abord !</strong>
					</div>
					<%
						}
						}

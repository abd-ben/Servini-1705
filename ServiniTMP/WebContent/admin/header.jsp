...
<%@page import="servini.bean.Personne"%>
...
<body>
	...
	<div class="navbar navbar-default" role="navigation">
		<%
			boolean isSet = (request.getSession().getAttribute("curent") == null);
			Personne p = new Personne();
			if (!isSet) {
				p = (Personne) request.getSession().getAttribute("curent");
			} else {
				response.sendRedirect("login.jsp?msg=echec");
			}
		%>
			...
			<div class="btn-group pull-right">
				<button class="btn btn-default dropdown-toggle"
					...
					<i class="glyphicon glyphicon-user"></i><span
						class="hidden-sm hidden-xs"> <%=p.getEmail()%></span> <span
						class="caret"></span>
				</button>
